...
-- ESTRUCTURA ORIGINAL (SIN CAMBIOS DE NOMBRES)
-- ==============================================
...
-- ==============================================
-- FUNCIONES Y TRIGGERS (Corregidos sintácticamente)
-- ==============================================
...
-- 9. Validar prerrequisitos (Lógica relacional corregida)
...
-- 10. Validar periodo activo (Corregido nombre de tabla a academico.PeriodoAcademico)
