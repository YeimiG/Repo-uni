...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Verificar roles permitidos (normaliza para evitar errores con acentos o mayúsculas).
      ...
      const normalizedRole = response.usuario.rol
        ?.normalize("NFD")
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            {[
              ...
              <span
                key={r.rol}
                className={`${r.color} px-2 py-1 rounded text-center font-medium`}
              >
                {r.rol}
              </span>
            ))}
