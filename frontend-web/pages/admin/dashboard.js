  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.buttons}>
        <button onClick={() => setMostrarForm("usuario")} style={styles.btn}>
          Crear Usuario
        </button>
        <button onClick={() => setMostrarForm("estudiante")} style={styles.btn}>
          Crear Estudiante
        </button>
        <button
        ...
        <button onClick={() => setMostrarForm("materia")} style={styles.btn}>
          Crear Materia
        </button>
      </div>
      ...
      {mostrarForm === "estudiante" && (
        ...
        >
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, expediente: e.target.value })
            }
            style={styles.input}
            required
          />
          ...
          <input
            ...
            type="number"
            onChange={(e) =>
              setFormData({ ...formData, idCarrera: e.target.value })
            }
            style={styles.input}
            required
          />
      ...
      {mostrarForm === "materia" && (
        <form onSubmit={(e) => handleSubmit(e, "materia")} style={styles.form}>
          ...
          <input
            placeholder="Código"
            onChange={(e) =>
              setFormData({ ...formData, codigoMateria: e.target.value })
            }
            style={styles.input}
            required
          />
          <input
            placeholder="Nombre"
            onChange={(e) =>
              setFormData({ ...formData, nombreMateria: e.target.value })
            }
            style={styles.input}
            required
          />
          <input
            ...
            type="number"
            onChange={(e) =>
              setFormData({ ...formData, unidadesValorativas: e.target.value })
            }
            style={styles.input}
            required
          />
